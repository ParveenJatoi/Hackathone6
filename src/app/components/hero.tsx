...
// const Hero = () => {
//   return (
//     <section className="relative bg-cover bg-center py-72" style={{ backgroundImage: "url('/heropic.jpg')" }}>
...
//           <div className="absolute top-4 right-4 bg-yellow-500 text-white py-1 px-2 rounded-full text-xs font-bold">
//             New Arrival
//           </div>
//           <h1 className="text-3xl md:text-5xl font-bold leading-tight mb-4 text-yellow-400">
...
//           </p>
//           <button className="bg-yellow-500 text-white py-2 px-6 rounded-lg hover:bg-yellow-600 transition-all duration-300">
//             Explore Now
//           </button>
//         </div>
//       </div>
