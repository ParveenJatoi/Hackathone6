  ...
  return (
    <div className="relative w-full max-w-5xl mx-auto p-4 md:p-8">
      ...
      <div className="mt-8 grid grid-cols-1 md:grid-cols-3 gap-10 md:gap-16">
        ...
        {/* Card 2 */}
        <div className="relative card2 w-full md:w-96 h-96 md:h-144">
          <Image
            src="/sofa1.png"
            alt="Card 2"
            layout="fill"
        ...
        {/* Card 3 */}
        <div className="relative card3 w-full md:w-96 h-96 md:h-144">
          <Image
            src="/vase1.png"
            alt="Card 2"
            layout="fill"
            ...
            className="rounded-md"
          />
          <div className="absolute bottom-[-50px] left-2 text-black p-2">Bed</div>
        </div>
      </div>
    </div>
  );
